...
export function HeaderMenu({ isAuthenticated }) {
  ...
  return (
    <div className="dropdown dropdown-end">
      ...
      <ul
        tabIndex={0}
        className="dropdown-content menu text-white font-semibold rounded-lg mt-2 z-50 bg-[#dedede]/30 backdrop-blur-2xl w-40 p-2 shadow-sm border border-[#dedede]/20"
      >
        {links.map((link) => (
